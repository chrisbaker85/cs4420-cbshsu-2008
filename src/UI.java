...
public class UI {
	...
	private boolean checkSyntax(String input) {
		...
		b = Pattern.matches("select ((\\*)|((([a-z_-]+)((\\.)([a-z_-]+))?)(,( )?([a-z_-]+)((\\.)([a-z_-]+))?)*)) from [a-zA-Z0-9_-]+(,( )?[a-zA-Z0-9_-]+)*( where ([a-zA-Z0-9_-]+((((\\.)([a-z_-]+))?))( )?[=<>]( )?(([a-zA-Z0-9_-]+)|('[a-zA-Z0-9_-]+')))((,( )?[a-zA-Z0-9_-]+(((\\.)([a-z_-]+))?)( )?[=<>]( )?(([a-zA-Z0-9_-]+)|('[a-zA-Z0-9_-]+'))+)*)?)?", input);
		if (b) {
